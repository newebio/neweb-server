...
class Seance {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (controller.data) {
                Object.keys(controller.data).map((fieldName) => {
                    ...
                    if (dataField instanceof rxjs_1.Observable || typeof (dataField.subscribe) === "function") {
                        dataField.subscribe((value) => {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.route$.pipe(operators_1.filter((r) => r.type === "notFound"))
                .subscribe(() => {
                console.log("404");
            });
    ...
    replacePage(oldPage, routePage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(info.newFrames.map((frame) => __awaiter(this, void 0, void 0, function* () {
                ...
                const data = yield this.waitControllerData(controller);
                frame.data = data;
    ...
    waitControllerData(controller) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = {};
            if (!controller.data) {
                return data;
            }
            yield Promise.all(Object.keys(controller.data).map((fieldName) => __awaiter(this, void 0, void 0, function* () {
                const field = controller.data[fieldName];
                data[fieldName] = field instanceof rxjs_1.Observable || typeof (field.pipe) === "function" ?
                    yield field.pipe(operators_1.take(1)).toPromise() :
                    field;
            })));
            return data;
        });
